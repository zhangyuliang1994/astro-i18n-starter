...
![MCP 配置示例](/images/blog/claude-code-tips/cc-11.jpeg)
...
![权限配置界面](/images/blog/claude-code-tips/cc-10.jpeg)
...
![斜杠命令示例](/images/blog/claude-code-tips/cc-7.jpeg)
...
![自动编辑模式](/images/blog/claude-code-tips/cc-1.jpeg)
...
![深度思考模式](/images/blog/claude-code-tips/cc-12.jpeg)
...
![Plan 模式](/images/blog/claude-code-tips/cc-6.png)
...
![CLAUDE.md 示例](/images/blog/claude-code-tips/cc-4.jpeg)

> 💡 如果是已经有代码的项目，建议使用 `/init` 命令自动生成

Claude 会自动根据 CLAUDE.md 的内容来调整行为：

![Claude 更新 CLAUDE.md](/images/blog/claude-code-tips/cc-5.jpeg)

### 8.3 Agents 配置

你还可以在 `.claude/agents` 目录下配置多个 Agent：

![Agents 目录结构](/images/blog/claude-code-tips/cc-8.png)

### 8.4 Hooks 配置

可以配置 Hooks 来自动执行命令：

![Hooks 配置示例](/images/blog/claude-code-tips/cc-9.jpeg)
...
Web 界面也可以查看历史 Sessions：

![Sessions 列表](/images/blog/claude-code-tips/cc-2.jpeg)
