...
![Prometheus 配置](/images/blog/prometheus-linux-metrics-api/prometheus-config.png)

### 三、指标查询

![PromQL 查询](/images/blog/prometheus-linux-metrics-api/promql-query.png)
...
![API 查询示例](/images/blog/prometheus-linux-metrics-api/api-query-example.png)
...
![Echarts 展示](/images/blog/prometheus-linux-metrics-api/echarts-display.png)
