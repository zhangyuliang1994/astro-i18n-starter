...
![Prometheus 配置](./imgs/prometheus-config.webp)

### 三、指标查询

![PromQL 查询](./imgs/promql-query.webp)
...
![API 查询示例](./imgs/api-query-example.webp)
...
![Echarts 展示](./imgs/echarts-display.webp)

### 五、指标查询

![Query Options](./imgs/query-options.webp)

Prometheus 上有个 Query Options，里面有个 Explore metrics，可以看到每个指标的含义。

![Explore metrics](./imgs/explore-metrics.webp)
