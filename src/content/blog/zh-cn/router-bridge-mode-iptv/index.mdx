...
![光猫端口信息](./imgs/cat-port-info.webp)

我使用的是网口 3，如图所示：

![光猫用户信息](./imgs/cat-user-info.webp)

#### 1.2 路由器设置

我使用的路由器是 Redmi AC2100，同时刷了老毛子固件，在浏览器输入 192.168.123.1，输入帐号和密码，进入如下界面：

![路由器插件](./imgs/route-plugin.webp)

在 高级设置 -> 外部网络 -> 外部设置里，将外网连接类型改为 PPPoE 拨号，在下方输入宽带帐号和密码即可。

![路由器桥接设置](./imgs/route-bridge.webp)
