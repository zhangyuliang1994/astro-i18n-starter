...
![线程池参数关系](/images/blog/java-threadpool-notes/threadpool-params.png)

### 三、线程池创建的两种方式

**方式一：通过 `ThreadPoolExecutor` 构造函数来创建（推荐）。**

![ThreadPoolExecutor 构造方式](/images/blog/java-threadpool-notes/threadpool-constructor.png)
...
![Executors 创建方式](/images/blog/java-threadpool-notes/threadpool-executors.png)
