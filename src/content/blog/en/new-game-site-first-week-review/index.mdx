...
![GSC data: 844 clicks, 39K impressions, 2.2% CTR over 7 days](./images/gsc-data.webp)
...
![GSC device data: mobile 527 clicks, desktop 311 clicks](./images/gsc-device.webp)
...
![GA data: 916 active users and 1,533 page views in the past 7 days](./images/ga-data.webp)
...
![GA country distribution: US dominant, followed by UK and Germany](./images/ga-countries.webp)
...
![Bing data: 52 clicks, 1.4K impressions](./images/bing-data.webp)
...
![Cloudflare data: 6.06K unique visitors, 168.91K requests, 26.94% cache rate](./images/cf-data.webp)
